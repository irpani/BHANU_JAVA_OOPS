...
public class Example1 {
	...
	public static void main(String[] args) {
		 ...
		 * Java, but there are subtle difference between them. ... valueOf() of java.
		 * lang. Integer returns an Integer object, while parseInt() method returns an
		 * int primitive
		 */
